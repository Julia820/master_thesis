...
best_auc_plot <- function(col, tit) {
  ...
  marker_auc_1 <- marker_auc_1[c(1:20), ]
...
markers <- data.frame(SEC23A=rna['ENSG00000100934', ], CCND2=rna['ENSG00000118971', ], NR5A1=rna['ENSG00000136931',], cluster=classes_pl)
fig <- plot_ly(data = markers, x = ~SEC23A, y = ~CCND2, z = ~NR5A1, color=~cluster, type="scatter3d")
