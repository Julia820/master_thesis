...
pasAnno <- "/home/juliarymuza/Dokumenty/rna_seq/id_info_rna_klaster.csv"
coldata <- read.csv(pasAnno)
rna <- read.csv('/media/juliarymuza/30802472802440A8/rna_seq/ALL_TPM.csv')
...
ggsave(file="../plots/immuno.eps", width = 30, height = 10, units = "cm")
```
